...
#############################################
# New WeatherBell-Style Colormap
#############################################
...
def run_inference_manhattan_gfs(
    ...
    # Create new WeatherBell colormap and norm
    weatherbell_cmap = weatherbell_precip_colormap()
    weatherbell_cmap.set_over(color='#aca0c7')
    ...
    weatherbell_norm = mcolors.BoundaryNorm(bounds, ncolors=len(weatherbell_cmap.colors))
    ...
    if data_source.upper() == "ECMWF":
        ...
        for i in range(n_times):
            ...
            im_pred = ax_pred.imshow(
                ...
                cmap=weatherbell_cmap,
                norm=weatherbell_norm
            )
