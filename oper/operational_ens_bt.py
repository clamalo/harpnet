...
coordinates = [40.56823, -111.63809]
...
# for member in range(last_member-first_member):
#     alpha_value = (member + 1) / (last_member-first_member)  # Calculate alpha value
