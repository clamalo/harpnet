...
for location, coordinates in stations.items():
    ...
    print(min(gfs_pred_ds_sum['latitude'].values), coordinates[0], max(gfs_pred_ds_sum['latitude'].values), min(gfs_pred_ds_sum['longitude'].values), coordinates[1], max(gfs_pred_ds_sum['longitude'].values))
